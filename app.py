...
def home():
    ...
    try:
        ...
        return f"Error rendering template: {str(e)}<br>App template folder: {app.template_folder}<br>Current directory: {os.getcwd()}"
...
@app.route('/emergency-create-template', methods=['POST'])
